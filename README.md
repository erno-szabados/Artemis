...
I've forked the Project to implement some modern features in Artemis:
Collections, utility APIs. I need a useful base library for my ML 
experiments in Oberon, so this motivates the work. - ES
